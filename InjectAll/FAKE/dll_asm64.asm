; ShellCode that is called from the kernel space as a user-mode APC to inject our DLL
; It must be base-independent because we don't know at what address in memory it may be mapped!
